...
class ReportAgent(Agent):
    ...
    def run(self, task, query, data):
        ...
        return self.generate_report(task, query, data)  # Ensure correct parameter passing

    def generate_code(self, query, data):
            """Generates a structured financial research report with detailed analysis spanning 25-30 pages."""
            prompt = f"""
            ...
            ## - Executive Summary**
            This section provides a high-level overview of the financial health and investment potential of {query}. Key findings and major takeaways are summarized here, including revenue trends, market position, and risk factors.
            ...
            ## - Conclusion**
            A final summary of the key insights, investment potential, and risk factors for {query}, incorporating both qualitative and quantitative evaluations.
            ...
            **Stock Data Overview:**
            ...
            - Ensure each section is **well-structured** with detailed, relevant insights.
            - Expand each section **with in-depth financial and market analysis**.
            - Use **real-world data and examples** to strengthen conclusions.
            - Maintain a **formal, analytical, and data-driven tone**.
            - Highlight **key financial metrics, trends, and industry comparisons**.
            """
