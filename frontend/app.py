...
if query and st.button("Generate Report"):
    ...
    if response.status_code == 200:
        ...
        if result.get("stock_chart"):
            st.image(result["stock_chart"], caption="Stock Performance Chart", use_column_width=True)
        else:
        ...
        st.subheader(" Chart Generated Using Snowflake Data:")
        ...
        if pdf_report:
            ...
            st.markdown(f"[Download PDF Report](http://127.0.0.1:8000/{pdf_report})", unsafe_allow_html=True)
        else:
